...
<ion-content id="{{id}}_dropdown" class="angucomplete-dropdown" on-touchstart="keepShowResult()" ng-mouseenter="keepShowResult()" ng-if="showDropdown"><div class="angucomplete-searching" ng-show="searching">Searching...</div>\n\
...
<ion-scroll ></ion-scroll></div></ion-content>\n\
</div>',
            link: function(scope, elem, attrs) {
                ...
                scope.hideResults = function() {
                    console.log("hide result " + scope.isMouseMove);
